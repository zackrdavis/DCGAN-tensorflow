...
class DCGAN(object):
    ...
    def train(self, config):
        ...
        if config.is_train_once:
            sample_z[0] = np.array([-0.67538577,  0.85746101, -0.02435941, -0.41338992,  0.52677993, -0.69799527, -0.82815583, -0.34414566, -0.86664912, -0.62203711,  0.62420933,  0.11016337,  0.71485664, -0.91338393,  0.30544229, -0.47050223, -0.56371716,  0.56873508,  0.42728038,  0.34502511,  0.83296207,  0.79792743, -0.36361443, -0.34123443,  0.5614612 , -0.74969634,  0.43343945, -0.36307761,  0.91507917,  0.41602934,  0.60936889, -0.71135811,  0.99502367, -0.35377693,  0.61442838,  0.66125171,  0.90016693,  0.86130131,  0.67395105, -0.69262018,  0.34131567, -0.0780487 , -0.50152968,  0.68960734, -0.50869798,  0.77555824,  0.54590249, -0.50752418,  0.61472897,  0.76524315, -0.19353204, -0.48336831,  0.31282501, -0.35732044, -0.89181876,  0.77027159,  0.36504397, -0.30067719, -0.99574575, -0.7490562 , -0.02863161, -0.05568626, -0.46552543, -0.87022661,  0.32000325,  0.59729428, -0.68055283,  0.15533735,  0.86431558,  0.28242675,  0.53755982,  0.53630477, -0.49074254, -0.66550615, -0.12975618, -0.42845217,  0.83280733, -0.96711122,  0.50197392,  0.35708108, -0.8970826 ,  0.04495864, -0.16703198, -0.67543506,  0.47351776, -0.43031924,  0.68263278,  0.9745486 ,  0.91051313, -0.0855169 ,  0.93804641, -0.97339515, -0.56571107, -0.00625369, -0.25020525,  0.44452736,  0.52809865,  0.16010302,  0.30894548,  0.55368681])
        ...
        for epoch in xrange(config.epoch):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                if np.mod(counter, 100) == 1 or config.is_train_once:
                    if config.dataset == 'mnist':
